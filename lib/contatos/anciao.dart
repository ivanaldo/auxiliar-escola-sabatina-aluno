...
class Anciao extends StatefulWidget {
  @override
  _AnciaoState createState() => _AnciaoState();
}
...
class _AnciaoState extends State<Anciao> {
  ...
  //retorna o ancião com o id da igreja retornado do metodo _retornaIdIgreja
  Future<dynamic> _retornaAnciao() async {
    FirebaseFirestore db = FirebaseFirestore.instance;
    QuerySnapshot querySnapshot = await db.collection("anciao")
          ...
          child: Column(
            ...
            children: <Widget>[
              Center(
                child: CircleAvatar(
                  radius: 100,
                  backgroundImage: AssetImage("imagens/logo_anciao.jpg"),
                ),
              ),
              Center(
                child: Text(
