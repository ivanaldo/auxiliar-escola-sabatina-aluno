...
class Provai extends StatefulWidget {
  @override
  _ProvaiState createState() => _ProvaiState();
}

class _ProvaiState extends State<Provai> {
  Channel _channel;
  String provai;
  ...
  Future<dynamic> _retornaProvai() async {
  ...
  _initChannel() async {
    Channel channel = await APIService.instance.fetchChannel(
        channelId: "UCCtWIqFrocvYlCvqDsV7Heg",
        playlistId: provai);
    setState(() {
      _channel = channel;
    });
