...
class Trimestre extends StatefulWidget {
  @override
  _TrimestreState createState() => _TrimestreState();
}
...
class _TrimestreState extends State<Trimestre> {
      ...
      for (DocumentSnapshot dados in snapshot.docs) {
        ...
        if(dados.exists) {
          setState(() {
            ...
            _presenca             = (presenca*100)/_trimestre;
            _estudouBiblia        = (estudouBiblia*100)/_trimestre;
            _pequenoGrupo        = (pequenoGrupo*100)/_trimestre;
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(padding: EdgeInsets.only(top: 36, bottom: 36),
                child: Center(
                  child: Text("Situação da classe nesse trimestre", style: TextStyle(fontSize: 18),),
                ),
              ),
              Center(
                child: Padding(
              ...
              Padding(
                ...
                child: Text("Membros presentes todos os sábados", style: TextStyle(fontSize: 16),
                ),
              ),
              Row(children: [
                Container(
